...
def vox2pix(cam_E, cam_k, 
    ...
    lidar_pts = fusion.TSDFVolume.vox2world(vox_origin, vox_coords, voxel_size)
    cam_pts = fusion.rigid_transform(lidar_pts, cam_E)
    ...
    return projected_pix, fov_mask, pix_z , lidar_pts
