...
class Down_layer(nn.Module):
    def __init__(
        ...
        self.process_l2 = Process(self.feature * 2, norm_layer, bn_momentum, dilations=[1, 1, 1])
        self.down_l2_l3 = Downsample(self.feature * 2, norm_layer, bn_momentum)
        self.fc = nn.Conv3d(self.feature * 4,self.feature , kernel_size=1,stride=1, bias=False)


    def forward(self, x3d_l1,t = None):
        x3d_l2 = self.down_l1_l2(self.process_l1(x3d_l1,t= t),t= t)
        x3d_l3 = self.down_l2_l3(self.process_l2(x3d_l2,t= t),t= t)
        return self.fc(x3d_l3)
